    ...
    card.innerHTML = `
      ...
      <div class="hero-card-info">
        ...
        <div class="hero-card-scores">
          ...
          ${h.altStats ? `<span class="score-badge avg-total" title="Total average across both stat sets">⌀ ${+((Number(scores.vScore) + Number(scores.hScore) + Number(h.altStats.vScore) + Number(h.altStats.hScore)) / 4).toFixed(1)}</span>` : ""}
        </div>
      </div>
